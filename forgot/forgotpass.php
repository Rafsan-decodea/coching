...
<body>
    <div class="container">
        ...
        <input type="number" id="myInput" name="phone" required>
        <button id="sendDataButton" type="submit">Sent Otp</button>
    ...
    $("#sendDataButton").click(function() {
        ...
        $.ajax({
            ...
            success: function(data, status) {
                ...
                if (data == "ok") {
                    //  $("#responseMessage").html("<p style='color:green'>Found </p>");
                    window.location.href = "/forgot/otpverify.php";
                }
                $("#responseMessage").html("<p style='color:Red'> Not Found </p>");
            },
